...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/mms/xfRecord.js"></script>
<script type="text/javascript">
	$(function() {
		xfRecordDataGrid("${pageContext.request.contextPath}","${accessButtons.data}","${accessButtons.type}");
	});
</script>
<div class="easyui-layout" fit="true" id="xfRecord-mainBody">
	<!-- Search panel start -->
	<div data-options="region:'north',title:'',border:false"
		style="overflow:hidden;padding:10px;" align="center" split="true">
		<form id="xfRecordSearchForm">
			<div class="searchmore">
				...
				<span class="imf_more"><input id="xfRecordBtnSearch" type="button" value="搜索" class="imf_searchmore"/></span>						
				<span class="imf_all"><input id="xfRecordBtnClean" type="button" value="显示全部" class="imf_showall"/></span>
			</div>
		</form>
	</div>
	<!--  Search panel end -->
	...
	<div data-options="region:'center',border:false" style="padding:5px;">
		<table id="xfRecord-data-list"></table>
	</div>
	
	<div id="xfRecord-role-div"></div>
	
	<!-- Edit Win&Form -->
	<div id="xfRecord-edit-win" class="imf_pop" style="width:440px;">
		<div class="imf_pop_title"><strong>消费记录</strong><span class="imf_pop_closed" onClick="popClosed('xfRecord-edit-win')">关闭</span></div>
		<form id="xfRecordEditForm" class="ui-form" method="post">
			...
			<div class="imf_pop_btn">
				<span><input type="button" id="xfRecord-save" value="保存" class="imf_pop_btn_save" onClick="xfRecordSave('${pageContext.request.contextPath}/xfRecordController/save.do')"/></span>
				<span><input type="button" id="xfRecord-close" value="关闭" class="imf_pop_btn_closed" onClick="popClosed('xfRecord-edit-win')"/></span>
			</div>
			<div class="imf_pop_error" id="xfRecord-edit-error"><p></p></div>
			<div class="imf_pop_correct" id="xfRecord-edit-info"><p></p></div>
		</form>
	</div>
</div>

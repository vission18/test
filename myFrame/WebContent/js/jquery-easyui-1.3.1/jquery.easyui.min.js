...
var win=$("<div class=\"messager-body\" style=\"position: relative;overflow:hidden;\">"+iframe+"</div>").appendTo("body");
//old code
...
function _38d(_38e){
var box=$(_38e);
	if($.data(_38e,"validatebox")){//add by jtao
...
function _448(_449,_44a,_44b){
	...
	if($.data(_449,"datagrid")){//add by jtao
...
cell.css("text-align",(col.headalign||"center"));//增加标题对齐属性设置，默认居中lyz
...
function _4a4(_4a5){
	if($.data(_4a5,"datagrid")){//add by jtao
...
$.fn.datagrid.methods={options:function(jq){
	if($.data(jq[0],"datagrid") && $.data(jq[0],"datagrid").options){//modify by Jtao 处理无数据时的异常
	...
	if($.data(jq[0],"datagrid")){//modify by Jtao 处理无数据时的异常
...
return jq.each(function(){
	if($(this).datagrid("getPager")){//modify by Jtao 处理无数据时的异常
		$(this).datagrid("getPager").pagination("loaded");		
	}
var _594=$(this).datagrid("getPanel");
	if(_594){//modify by Jtao 处理无数据时的异常
...
//modify by limt 2013-11-14
//$(_5b1).html(_5b5.join(""));//anno this line
$(_5b1)[0].innerHTML = _5b5.join("");//add this line
...
var opts=$(this).datagrid("options");
if(!opts){//modify by Jtao 处理无数据时的异常
return false;	
}
if(!opts.url){
return false;
...
function _66c(_66d,_66e,data,_66f){
	if($.data(_66d,"treegrid")){//add by jtao
...
//modify by jtao
var iframe = "<iframe name='kill_activex' frameborder='0' style='position: absolute; z-index: -1; width: 100%; height: 100%; top: 0;left:0;scrolling:no;'></iframe>";
var _70d=$("<div class=\"combo-panel\" style=\"position: relative;\">" + iframe + "</div>").appendTo("body");
//old code
...
function _732(_733){
var _734=[];
	if($.data(_733,"combo")){//add by jtao
...
function _76b(_76c,data,_76d){
	if($.data(_76c,"combobox")){//add by jtao
...
function _793(_794,_795){
	if($.data(_794,"combotree")){//add by jtao
